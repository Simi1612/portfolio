  ...
  return (
    ...
    >
      ...
      <motion.h1
        ...
        className="text-[40px] font-semibold text-transparent bg-clip-text bg-gradient-to-r from-purple-500 to-cyan-500 pb-14"
      >
        About Me
      </motion.h1>

      <div className="w-[90%] max-w-[1100px] flex flex-col gap-10">
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <motion.div
            ...
            className="flex-1 bg-[#03001457] border border-[#2A0E61] rounded-2xl p-8 backdrop-blur-md flex flex-col gap-5"
          >
            {/* Name badge */}
            <div className="flex items-center gap-3 mb-1">
              <div className="w-1 h-10 rounded-full bg-gradient-to-b from-purple-500 to-cyan-500" />
              <div>
                <h2 className="text-white font-bold text-xl">Smruti Katariya</h2>
                <p className="text-purple-400 text-sm font-medium">AI Developer & ML Engineer</p>
              </div>
            </div>
            ...
            <a
              ...
              className="mt-2 flex items-center gap-2 self-start py-2.5 px-6 rounded-lg border border-[#7042f88b] bg-[#03001457] text-[#b49bff] hover:text-white hover:bg-purple-600/30 transition-all duration-300 hover:scale-105 active:scale-95 font-medium backdrop-blur-sm text-sm"
            >
              View Resume
          ...
          >
            {/* Tech skills */}
            <div className="bg-[#03001457] border border-[#2A0E61] rounded-2xl p-6 backdrop-blur-md">
        ...
        >
          {STATS.map((stat) => (
            <div
              key={stat.label}
              className="flex flex-col items-center justify-center p-6 rounded-2xl border border-[#2A0E61] bg-[#03001457] backdrop-blur-md hover:border-[#7042f88b] transition-all duration-300 group"
            >
              <span className="text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-cyan-400 group-hover:scale-110 transition-transform duration-300">
                {stat.value}
              </span>
